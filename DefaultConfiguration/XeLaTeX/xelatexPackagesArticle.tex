...
\newcommand{\myTitle}{\inColor{\fontsize{1.3cm}{1em}\selectfont Titre du document}}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	...
	\section{section 1}
	\subsection{sectoin 1.1}
	\subsubsection{section 1.1.1}
	\infoInfo{information}{ceci est une information de la plus haute importance !}
	\warningInfo{information}{ceci est une information de la plus haute importance !}
	\criticalInfo{information}{ceci est une information de la plus haute importance !}
	\questionInfo{information}{ceci est une information de la plus haute importance !}
	\checkInfo{information}{ceci est une information de la plus haute importance !}
